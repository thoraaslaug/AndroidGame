...
public class QuestData : MonoBehaviour
{
    ...
    private void addQuestions()
    {
        ...
        Answer answer3 = new Answer("Värmeenergi", false, 1);
    ...
    void dataBs()
    {
        ...
        addQuest(new Answer("Danmark", true, -1), new Answer("Island", false, 0), new Answer("Sverige", true, 1), "Grönland är inget eget land utan hör till…?");
        addQuest(new Answer("Brasília", true, -1), new Answer("Rio de Janeiro", false, 0), new Answer("Sao Paulo", false, 1), "Vilken är Brasiliens huvudstad?");
        ...
        addQuest(new Answer("1531-1558", false, -1), new Answer("1523-1560", true, 0), new Answer("1508-1539", true, 1), "Vilka år var Gustav Vasa Kung av Sverige");
        ...
        addQuest(new Answer("Sverige ", false, 0), new Answer("Island ", true, 1), new Answer("Norge", false, -1), "Vilket land tillhör INTE Skandinavien?");
        addQuest(new Answer("1985 ", false, 0), new Answer("1989 ", true, 1), new Answer("1991", false, -1), "Vilket år revs Berlinmuren ner?");
